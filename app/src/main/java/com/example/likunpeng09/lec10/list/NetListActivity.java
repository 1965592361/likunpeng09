package com.example.likunpeng09.lec10.list;
...
import com.example.likunpeng09.R;
import com.example.likunpeng09.lec09.NetInputUtils;
import com.example.likunpeng09.lec10.HttpProxy;
import com.example.likunpeng09.lec10.SignActivity;
import com.example.likunpeng09.lec10.bean.VideoInfo;
import com.example.likunpeng09.lec10.bean.VideoListResponse;
        ...
        switch (requestCode) {
            case RequestCode: {
                if (RESULT_OK == resultCode) {
                    ...
                    Toast.makeText(this, "李昆鹏  取消了设置", Toast.LENGTH_SHORT).show();
                }
            }
            break;
        }
